...
#define LFB_SCLK				LED_FEEDBACK_SCLK_Pin
#define LFB_SCLK_PORT		LED_FEEDBACK_SCLK_GPIO_Port
#define LFB_SIN					LED_FEEDBACK_SIN_Pin
#define LFB_SIN_PORT		LED_FEEDBACK_SIN_GPIO_Port
#define LFB_SOUT				LED_FEEDBACK_SOUT_Pin
#define LFB_SOUT_PORT		LED_FEEDBACK_SOUT_GPIO_Port
#define LFB_LATCH				LED_FEEDBACK_LATCH_Pin
#define LFB_LATCH_PORT	LED_FEEDBACK_LATCH_GPIO_Port
